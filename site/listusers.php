...
if (file_exists($file)) {
    ...
    echo "<tr><th>Nom</th><th>Prenom</th><th>CIN</th><th>password</th></tr>";
    ...
    foreach ($users as $user) {
        ...
        list($nom, $prenom, $cin, $password) = explode(', ', $user);

        // Clean the extracted data
        $nom = str_replace('Nom: ', '', $nom);
        $prenom = str_replace('Prenom: ', '', $prenom);
        $cin = str_replace('CIN: ', '', $cin);
